    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            ...
            <div class="col-lg-8 align-self-baseline">
                <p class="text-white-75 font-weight-light mb-5">INTERNET DE LAS COSAS (IoT)</p>
                <p class="text-white-75 font-weight-light mb-5">Ha llegado para cambiar al mundo…</p>
