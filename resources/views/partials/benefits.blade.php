            ...
            <div class="col-lg-4 col-sm-6">
                <a class="benefits-box" >
                    ...
                    <div class="benefits-box-caption">
                        ...
                        <div class="project-name">Acelerar la toma de decisiones</div>
                    </div>
                </a>
            </div>
            <div class="col-lg-4 col-sm-6">
                <a class="benefits-box">
                    ...
                    <div class="benefits-box-caption">
                        ...
                        <div class="project-name">Desarrollo de software especializado</div>
                    </div>
                </a>
            </div>
            <div class="col-lg-4 col-sm-6">
                <a class="benefits-box" >
                    ...
                    <div class="benefits-box-caption">
                        ...
                        <div class="project-name">Aumentar la productividad</div>
                    </div>
                </a>
            </div>
            <div class="col-lg-4 col-sm-6">
            ...
            <div class="col-lg-4 col-sm-6">
                <a class="benefits-box">
                    ...
                    <div class="benefits-box-caption p-3">
                        ...
                        <div class="project-name">Optimización de operaciones y reducción de costos</div>
                    </div>
                </a>
            </div>
            <div class="col-lg-4 col-sm-6">
                <a class="benefits-box">
                    ...
                    <div class="benefits-box-caption p-3">
                        ...
                        <div class="project-name">Inspiración y aprendizaje mediante Monitoreo</div>
                    </div>
                </a>
            </div>
            <div class="col-lg-4 col-sm-6">
